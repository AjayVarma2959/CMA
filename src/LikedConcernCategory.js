...
import './LikedConcernCategory.css';
import NewsForLiked from './NewsForLiked';

function LikedConcernCategory() {
  ...
  return (
    <div>
      ...
      <h1 className="h1v1Concern111" style={{ color: 'blue' }}>
        <span style={{ color: 'orange' }}>👍</span> Liked Concern
      </h1>
...
export default LikedConcernCategory;